...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 249344,
    DYNAMIC_BASE = 5492224,
    DYNAMICTOP_PTR = 249184;
...
var wasmBinaryFile = 'myengine.wasm';
...
var ASM_CONSTS = {
  1024: function() {ctx = canvas_myengine.getContext("webgl2", settings_myengine); myengine.handle = GL.registerContext(ctx, settings_myengine); GL.makeContextCurrent(myengine.handle); myengine.ctx = ctx;},  
 1214: function() {myengine.comp = canvas_composite.getContext("2d");},  
 1269: function() {const ctx_offscreen = canvas_filament.getContext("webgl2", settings_filamenet); ctx_offscreen.getExtension('WEBGL_compressed_texture_s3tc'); ctx_offscreen.getExtension('WEBGL_compressed_texture_astc'); ctx_offscreen.getExtension('WEBGL_compressed_texture_etc'); myengine.handle_offscreen = GL.registerContext(ctx_offscreen, settings_filamenet); GL.makeContextCurrent(myengine.handle_offscreen);},  
 1724: function() {GL.makeContextCurrent(myengine.handle_offscreen);},  
 1778: function() {GL.makeContextCurrent(myengine.handle);},  
 1848: function() {myengine.comp.drawImage(canvas_filament, 0, 0); myengine.comp.drawImage(canvas_myengine, 0, 0);},  
 199340: function() {GL.currArrayBuffer = GLctx.currentArrayBufferBinding;}
};
...
// {{PRE_LIBRARY}}
  ...
  var specialHTMLTargets=[0, typeof document !== 'undefined' ? document : 0, typeof window !== 'undefined' ? window : 0];function __getBoundingClientRect(e) {
