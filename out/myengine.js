...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 248800,
    DYNAMIC_BASE = 5491680,
    DYNAMICTOP_PTR = 248640;
...
var ASM_CONSTS = {
  1024: function() {const ctx = canvas.getContext("webgl2", defaults); ctx.getExtension('WEBGL_compressed_texture_s3tc'); ctx.getExtension('WEBGL_compressed_texture_astc'); ctx.getExtension('WEBGL_compressed_texture_etc'); const handle = GL.registerContext(ctx, defaults); GL.makeContextCurrent(handle);},  
 198796: function() {GL.currArrayBuffer = GLctx.currentArrayBufferBinding;}
};
